    ...
    <div class="container-fluid no-padding">
    	...
    	<!-- / Top info -->
				...
				<nav class="navbar navbar-default navbar-fixed-top site-nav">
					<div class="container">
						<div class="row">
			    			<div class="col-md-6 col-sm-6"><span>TELÉFONO: 011-4701-9316 &amp; líneas rotativas</span> EMAIL:&nbsp;<a href="mailto:ventas@raien.com.ar" style="color:#fff">ventas@raien.com.ar</a></div>
	    		...
	    		<nav class="navbar navbar-default navbar-fixed-top raien-site-navbar" id="navbar-desktop">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      ...
				      <ul class="nav navbar-nav navbar-right">
				        ...
				        <li><a href="<?=base_url();?>show/engineering" title="ingeniería" class="<?if($active_tab == 'ingenieria'){echo "active-menu";}?>">ingeniería</a></li>
